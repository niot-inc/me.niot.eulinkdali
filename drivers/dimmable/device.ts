...
module.exports = class DimmableDevice extends Homey.Device {

  /**
   * onInit is called when the device is initialized.
   */
  async onInit() {
    this.log('DimmableDevice has been initialized');
   ...
   */
  async onAdded() {
    this.log('DimmableDevice has been added');
  }
  ...
  async onSettings({
    ...
    this.log('DimmableDevice settings where changed');
  }
  ...
  async onRenamed(name: string) {
    this.log('DimmableDevice was renamed');
  }
   ...
   */
  async onDeleted() {
    this.log('DimmableDevice has been deleted');
  }
